 ...
 * @Version 1.0
 */
public class SvnUpdateScriptJar implements ILogicUnit
{
    ...
    {
        boolean hasUpdate = SvnOperaLocalUtil.hasUpdate(CheckConfig.getSvnScriptPath(), CheckConfig.getSvnScriptRemotePath());
        BPLog.BP_SVN.info("更新目录:{} 完毕, 更新结果 [{}]", CheckConfig.getSvnScriptPath(), hasUpdate);
